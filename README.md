...
- Spring Boot and Spring Cloud Config for building scalable and resilient applications.
- Netflix OSS components such as Eureka, Zuul, and Hystrix for service discovery, routing, and fault tolerance.
- Pivotal Cloud Foundry (PCF) for cloud-native deployment and management.
